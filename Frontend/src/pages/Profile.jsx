...
const Profile = () => {
  const { user, updateUser } = useAuth(); // Use context for source of truth and updates
  ...
  // Sync local form state when user changes (e.g. initial load)
  useEffect(() => {
      if (user) {
          setEditForm({
              name: user.name || "",
  ...
  const saveProfile = async () => {
      ...
      try {
          ...
          // Update Context! This will automatically update Navbar and other components
  ...
  return (
    <div className="min-h-screen bg-gray-50 dark:bg-gray-900 py-12 px-4 sm:px-6 lg:px-8 transition-colors duration-300">
      <div className="max-w-4xl mx-auto">
        ...
        <div className="bg-white dark:bg-gray-800 rounded-3xl shadow-xl overflow-hidden mb-8 transition-colors duration-300">
          ...
          <div className="px-8 pb-8">
            <div className="relative flex justify-between items-end -mt-12 mb-6">
              <div className="bg-white dark:bg-gray-800 p-1 rounded-full transition-colors duration-300 relative group">
                ...
                <div>
                  ...
                  <p className="text-gray-500 dark:text-gray-400">{user?.email}</p>
                   ...
                   <div className="mt-4 flex flex-wrap gap-4">
                     ...
                     <span className="px-3 py-1 bg-purple-50 dark:bg-purple-900/30 text-purple-700 dark:text-purple-300 rounded-full text-sm font-medium capitalize">Role: {user?.role || 'Seeker'}</span>
                  </div>
                ...
                <div className="space-y-4 max-w-lg">
                    <div>
                        ...
                        <input 
                            ...
                            className="w-full mt-1 px-3 py-2 bg-gray-50 dark:bg-gray-700 border border-gray-300 dark:border-gray-600 rounded-lg focus:outline-none focus:ring-2 focus:ring-indigo-500 dark:text-white"
                        />
                    </div>
                    <div>
                    ...
                    <div>
                        ...
                        <div className="h-48 rounded-lg overflow-hidden border border-gray-300 dark:border-gray-600">
                             <LocationPicker onLocationSelect={handleLocationSelect} initialPosition={user?.location?.coordinates ? { lat: user.location.coordinates[1], lng: user.location.coordinates[0] } : null} />
                        </div>
                    </div>
                    <button 
                        onClick={saveProfile}
        ...
        {/* Stats / Activity Placeholder (Existing) */}
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
           ...
           <div className="md:col-span-2 space-y-6">
              <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-sm p-8 text-center transition-colors duration-300">
                 ...
                 <p className="text-gray-500 dark:text-gray-400 mb-6">Activity feed coming soon.</p>
              </div>
           </div>
        </div>
      </div>
